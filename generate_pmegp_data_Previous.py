...
# List of activities classified as Manufacturing
manufacturing_activities = [
    'Manufacturing', 'Food Processing', 'Textile Unit', 'Handicraft'
    # Add other actual activities classified as manufacturing as needed
]

def assign_sector(activity):
    """Assign sector based on activity name."""
    if activity in manufacturing_activities:
...
def generate_pmegp_data(num_records):
    ...
    # Add SECTOR column using ACTIVITY_NAME
    df['SECTOR'] = df['ACTIVITY_NAME'].apply(assign_sector)
